...
<BlogImageGallery
  label="OneKey Classic 1S packaging and in-box materials"
  images={[
    {
      src: boxAccessories,
      alt: "OneKey Classic 1S box, device tray, recovery sheets, and quick-start card on a wooden table",
      caption: "Box, device tray, recovery sheets, and quick-start card.",
    },
    {
      src: retailBoxCloseup,
      alt: "OneKey Classic 1S retail box close-up",
      caption: "Retail box close-up before setup.",
    },
  ]}
/>
